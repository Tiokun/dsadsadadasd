...
{
	WeaponCfg[WEAPON_DEAGLE].nFallbackPaintKit = 37;
	WeaponCfg[WEAPON_DEAGLE].nFallbackSeed = 279;
	WeaponCfg[WEAPON_DEAGLE].stickers[0].nIndex = 37;
	WeaponCfg[WEAPON_DEAGLE].stickers[1].nIndex = 37;
	WeaponCfg[WEAPON_DEAGLE].stickers[2].nIndex = 37;
	WeaponCfg[WEAPON_DEAGLE].stickers[3].nIndex = 37;
	WeaponCfg[WEAPON_GLOCK].nFallbackPaintKit = 3;
	WeaponCfg[WEAPON_GLOCK].stickers[0].nIndex = 60;
	WeaponCfg[WEAPON_GLOCK].stickers[1].nIndex = 60;
	WeaponCfg[WEAPON_GLOCK].stickers[2].nIndex = 60;
	WeaponCfg[WEAPON_P250].nFallbackPaintKit = 678;
	WeaponCfg[WEAPON_TEC9].nFallbackPaintKit = 614;
	WeaponCfg[WEAPON_USP_SILENCER].nFallbackPaintKit = 657;
	...
	WeaponCfg[WEAPON_AK47].nFallbackPaintKit = 394;
	WeaponCfg[WEAPON_AK47].stickers[0].nIndex = 74;
	WeaponCfg[WEAPON_AK47].stickers[1].nIndex = 74;
	WeaponCfg[WEAPON_AK47].stickers[2].nIndex = 74;
	WeaponCfg[WEAPON_AK47].stickers[3].nIndex = 74;
	WeaponCfg[WEAPON_AWP].nFallbackPaintKit = 279;
	WeaponCfg[WEAPON_AWP].flFallbackWear = 0.9999999f;
	WeaponCfg[WEAPON_AWP].stickers[3].nIndex = 37;
	WeaponCfg[WEAPON_M4A1_SILENCER].nFallbackPaintKit = 497;
	WeaponCfg[WEAPON_M4A1].nFallbackPaintKit = 632;
	WeaponCfg[WEAPON_SSG08].nFallbackPaintKit = 503;
	WeaponCfg[WEAPON_UMP45].nFallbackPaintKit = 37;
	WeaponCfg[WEAPON_CZ75A].nFallbackPaintKit = 543;
	WeaponCfg[WEAPON_CZ75A].stickers[0].nIndex = 84;
	WeaponCfg[WEAPON_CZ75A].stickers[1].nIndex = 84;
	WeaponCfg[WEAPON_CZ75A].stickers[2].nIndex = 84;
	WeaponCfg[WEAPON_CZ75A].stickers[3].nIndex = 84;
	...
	GloveCfg.nFallbackPaintKit = 10039;
}
